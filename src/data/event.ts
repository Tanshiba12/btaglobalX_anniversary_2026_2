import type { EventPartner } from "@/types/content";
...
export const eventDetails = {
  ...
  social: "@BTA GlobalX",
  promise: "One invitation. One day. Many stages of excellence.",
  invitation: "Join us to celebrate a journey of memories, and heartfelt gratitude.",
  overview:
    "An anniversary made to be seen, shared, and remembered, bringing wellness, culture, recognition, media, and global connection into one full-day celebration."
};
